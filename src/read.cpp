...
void Read::analyze(OutputStructure& output){
    ...
    cout<<endl<<endl<<this->identifier<<" - O: " <<this->originalSequence
        <<endl<<endl<<this->identifier<<" - C: " <<this->correctedSequence
        <<endl<<endl<<this->identifier<<" - R: " <<this->referenceSequence;
